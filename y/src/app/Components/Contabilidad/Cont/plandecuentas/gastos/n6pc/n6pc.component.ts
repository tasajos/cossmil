...
import { CProductosIntern5,CProductosIntern6 } from 'src/app/Interfaz/contabilidad';
import { ActivatedRoute, Router } from '@angular/router';

@Component({
  selector: 'app-n6pc',
  templateUrl: './n6pc.component.html',
  styleUrls: ['./n6pc.component.css']
})
export class N6pcComponent implements OnInit {
  formulario: FormGroup;
  activos: CProductosIntern5[] = [];
  filteredActivos: CProductosIntern5[] = []; // Lista filtrada de activos
  ...
  registrarcuenta() {
     ...
     const rcactivo: CProductosIntern6 = {
    ...
    this._rcontabilidadchicaService.postcuentaproducto6(rcactivo).subscribe(_data => {
  ...
  this._rcontabilidadchicaService.getcuentaproducto5().subscribe(
    (activos: CProductosIntern5[]) => {
