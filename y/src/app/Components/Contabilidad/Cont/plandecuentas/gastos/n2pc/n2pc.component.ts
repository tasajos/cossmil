...
import { CDistrIntern2,CProductosIntern2 } from 'src/app/Interfaz/contabilidad';
...
@Component({
  selector: 'app-n2pc',
  templateUrl: './n2pc.component.html',
  styleUrls: ['./n2pc.component.css']
})
export class N2pcComponent implements OnInit {
  ...
  registrarcuenta() {
    const rcactivo: CProductosIntern2 = {
...
this._rcontabilidadchicaService.postcuentaproducto2(rcactivo).subscribe(_data => {
  this.mensajeExito('registrado');
  location.reload();
  this.router.navigate(['/pgastos']);
})
