...
import { PatrimonioIntern2,PatrimonioIntern3} from 'src/app/Interfaz/contabilidad';
import { ActivatedRoute, Router } from '@angular/router';


@Component({
  selector: 'app-n3pat',
  templateUrl: './n3pat.component.html',
  styleUrls: ['./n3pat.component.css']
})
export class N3patComponent implements OnInit {
  formulario: FormGroup;
  activos: PatrimonioIntern2[] = [];
  filteredActivos: PatrimonioIntern2[] = []; // Lista filtrada de activos
  ...
  registrarcuenta() {
     ...
     const rcactivo: PatrimonioIntern3 = {
    ...
    this._rcontabilidadchicaService.postpatrimonion3(rcactivo).subscribe(_data => {
      this.mensajeExito('registrado');
      location.reload();
      this.router.navigate(['/ppatrimonio3']);
    });
  }
