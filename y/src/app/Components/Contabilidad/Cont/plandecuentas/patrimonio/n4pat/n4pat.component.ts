...
import { ActivoIntern3,PasivoIntern3,PasivoIntern4,PatrimonioIntern3,PatrimonioIntern4 } from 'src/app/Interfaz/contabilidad';
import { ActivatedRoute, Router } from '@angular/router';


@Component({
  selector: 'app-n4pat',
  templateUrl: './n4pat.component.html',
  styleUrls: ['./n4pat.component.css']
})
export class N4patComponent implements OnInit {
  formulario: FormGroup;
  activos: PatrimonioIntern3[] = [];
  filteredActivos: PatrimonioIntern3[] = []; // Lista filtrada de activos
  ...
  registrarcuenta() {
     ...
     const rcactivo: PatrimonioIntern4 = {
    ...
    this._rcontabilidadchicaService.postpatrimonion4(rcactivo).subscribe(_data => {
  ...
  this._rcontabilidadchicaService.getpatrimonion3().subscribe(
    (activos: PatrimonioIntern3[]) => {
