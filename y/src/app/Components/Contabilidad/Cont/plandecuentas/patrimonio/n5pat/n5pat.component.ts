...
import { PasivoIntern4,PasivoIntern5,PatrimonioIntern4,PatrimonioIntern5 } from 'src/app/Interfaz/contabilidad';
import { ActivatedRoute, Router } from '@angular/router';

@Component({
  selector: 'app-n5pat',
  templateUrl: './n5pat.component.html',
  styleUrls: ['./n5pat.component.css']
})
export class N5patComponent implements OnInit {
  formulario: FormGroup;
  activos: PatrimonioIntern4[] = [];
  filteredActivos: PatrimonioIntern4[] = []; // Lista filtrada de activos
  ...
  registrarcuenta() {
     ...
     const rcactivo: PatrimonioIntern5 = {
    ...
    this._rcontabilidadchicaService.postpatrimonion5(rcactivo).subscribe(_data => {
  ...
  this._rcontabilidadchicaService.getpatrimonion4().subscribe(
    (activos: PatrimonioIntern4[]) => {
