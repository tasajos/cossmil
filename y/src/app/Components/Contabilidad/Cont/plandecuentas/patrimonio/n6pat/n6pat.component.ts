...
import { PasivoIntern5,PasivoIntern6, PatrimonioIntern5,PatrimonioIntern6 } from 'src/app/Interfaz/contabilidad';
import { ActivatedRoute, Router } from '@angular/router';

@Component({
  selector: 'app-n6pat',
  templateUrl: './n6pat.component.html',
  styleUrls: ['./n6pat.component.css']
})
export class N6patComponent implements OnInit {
  formulario: FormGroup;
  activos: PatrimonioIntern5[] = [];
  filteredActivos: PatrimonioIntern5[] = []; // Lista filtrada de activos
  ...
  registrarcuenta() {
     ...
     const rcactivo: PatrimonioIntern6 = {
    ...
    this._rcontabilidadchicaService.postpatrimonion6(rcactivo).subscribe(_data => {
      this.mensajeExito('registrado');
      location.reload();
      this.router.navigate(['/ppasivo6']);
    });
  }
  ...
  this._rcontabilidadchicaService.getpatrimonion5().subscribe(
    (activos: PatrimonioIntern5[]) => {
