...
import { PasivoIntern2 } from 'src/app/Interfaz/contabilidad';
import { ReactiveFormsModule } from '@angular/forms';
import { ActivatedRoute, Router } from '@angular/router';

@Component({
  selector: 'app-n2p',
  templateUrl: './n2p.component.html',
  styleUrls: ['./n2p.component.css']
})
export class N2pComponent implements OnInit {
...
this._rcontabilidadchicaService.postpasivon2(rcactivo).subscribe(_data => {
