...
import { ActivoIntern3,PasivoIntern3,PasivoIntern4 } from 'src/app/Interfaz/contabilidad';
import { ActivatedRoute, Router } from '@angular/router';


@Component({
  selector: 'app-n4p',
  templateUrl: './n4p.component.html',
  styleUrls: ['./n4p.component.css']
})
export class N4pComponent implements OnInit {
  formulario: FormGroup;
  activos: PasivoIntern3[] = [];
  filteredActivos: PasivoIntern3[] = []; // Lista filtrada de activos
  ...
  registrarcuenta() {
    ...
    this._rcontabilidadchicaService.postpasivon4(rcactivo).subscribe(_data => {
  ...
  this._rcontabilidadchicaService.getpasivon3().subscribe(
    (activos: PasivoIntern3[]) => {
