...
import { ActivoIntern4, ActivoIntern5,PasivoIntern4,PasivoIntern5 } from 'src/app/Interfaz/contabilidad';
import { ActivatedRoute, Router } from '@angular/router';


@Component({
  selector: 'app-n5p',
  templateUrl: './n5p.component.html',
  styleUrls: ['./n5p.component.css']
})
export class N5pComponent implements OnInit {
  formulario: FormGroup;
  activos: PasivoIntern4[] = [];
  filteredActivos: PasivoIntern4[] = []; // Lista filtrada de activos
  ...
  registrarcuenta() {
    ...
    this._rcontabilidadchicaService.postpasivon5(rcactivo).subscribe(_data => {
  ...
  this._rcontabilidadchicaService.getpasivon4().subscribe(
    (activos: PasivoIntern4[]) => {
