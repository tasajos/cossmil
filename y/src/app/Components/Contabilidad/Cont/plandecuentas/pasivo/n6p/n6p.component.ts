...
import { ActivoIntern4, ActivoIntern5, ActivoIntern6,PasivoIntern5,PasivoIntern6 } from 'src/app/Interfaz/contabilidad';
import { ActivatedRoute, Router } from '@angular/router';


@Component({
  selector: 'app-n6p',
  templateUrl: './n6p.component.html',
  styleUrls: ['./n6p.component.css']
})
export class N6pComponent implements OnInit {
  formulario: FormGroup;
  activos: PasivoIntern5[] = [];
  filteredActivos: PasivoIntern5[] = []; // Lista filtrada de activos
  ...
  registrarcuenta() {
    ...
    this._rcontabilidadchicaService.postpasivon6(rcactivo).subscribe(_data => {
  ...
  this._rcontabilidadchicaService.getpasivon5().subscribe(
    (activos: PasivoIntern5[]) => {
