...
import { PasivoIntern2, PatrimonioIntern2,CDistrIntern2 } from 'src/app/Interfaz/contabilidad';
...
@Component({
  selector: 'app-n2cd',
  templateUrl: './n2cd.component.html',
  styleUrls: ['./n2cd.component.css']
})
export class N2cdComponent implements OnInit {
...
this._rcontabilidadchicaService.postcuentadistribucion2(rcactivo).subscribe(_data => {
