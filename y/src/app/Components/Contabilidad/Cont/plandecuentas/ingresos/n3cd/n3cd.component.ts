...
import { PatrimonioIntern2,PatrimonioIntern3,CDistrIntern2,CDistrIntern3} from 'src/app/Interfaz/contabilidad';
...
@Component({
  selector: 'app-n3cd',
  templateUrl: './n3cd.component.html',
  styleUrls: ['./n3cd.component.css']
})
export class N3cdComponent implements OnInit {
  formulario: FormGroup;
  activos: CDistrIntern2[] = [];
  filteredActivos: CDistrIntern2[] = []; // Lista filtrada de activos
  ...
  registrarcuenta() {
    ...
    this._rcontabilidadchicaService.postcuentadistribucion3(rcactivo).subscribe(_data => {
  ...
  this._rcontabilidadchicaService.getcuentadistribucion2().subscribe(
    (activos: CDistrIntern2[]) => {
