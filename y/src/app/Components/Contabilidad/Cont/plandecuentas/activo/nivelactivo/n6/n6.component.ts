...
import { ActivoIntern4, ActivoIntern5, ActivoIntern6 } from 'src/app/Interfaz/contabilidad';
import { ActivatedRoute, Router } from '@angular/router';

@Component({
  selector: 'app-n6',
  templateUrl: './n6.component.html',
  styleUrls: ['./n6.component.css']
})
export class N6Component implements OnInit {
  formulario: FormGroup;
  activos: ActivoIntern5[] = [];
  filteredActivos: ActivoIntern5[] = []; // Lista filtrada de activos
  ...
  registrarcuenta() {
    ...
    this._rcontabilidadchicaService.postactivon6(rcactivo).subscribe(_data => {
  ...
  this._rcontabilidadchicaService.getactivon5a().subscribe(
    (activos: ActivoIntern5[]) => {
