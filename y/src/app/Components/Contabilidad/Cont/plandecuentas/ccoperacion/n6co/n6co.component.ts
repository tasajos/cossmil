...
import { COperacionIntern5, COperacionIntern6 } from 'src/app/Interfaz/contabilidad';
import { ActivatedRoute, Router } from '@angular/router';


@Component({
  selector: 'app-n6co',
  templateUrl: './n6co.component.html',
  styleUrls: ['./n6co.component.css']
})
export class N6coComponent implements OnInit {
  formulario: FormGroup;
  activos: COperacionIntern5[] = [];
  filteredActivos: COperacionIntern5[] = []; // Lista filtrada de activos
  ...
  registrarcuenta() {
     ...
     const rcactivo: COperacionIntern6 = {
    ...
    this._rcontabilidadchicaService.postcostooperacion6(rcactivo).subscribe(_data => {
  ...
  this._rcontabilidadchicaService.getcostooperacion5().subscribe(
    (activos: COperacionIntern5[]) => {
