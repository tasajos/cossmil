...
import { COperacionIntern2 } from 'src/app/Interfaz/contabilidad';
import { ReactiveFormsModule } from '@angular/forms';
import { ActivatedRoute, Router } from '@angular/router';

@Component({
  selector: 'app-n2co',
  templateUrl: './n2co.component.html',
  styleUrls: ['./n2co.component.css']
})
export class N2coComponent implements OnInit {
  ...
  registrarcuenta() {
    const rcactivo: COperacionIntern2 = {
...
this._rcontabilidadchicaService.postcostooperacion2(rcactivo).subscribe(_data => {
  this.mensajeExito('registrado');
  location.reload();
  this.router.navigate(['/coperacion']);
})
