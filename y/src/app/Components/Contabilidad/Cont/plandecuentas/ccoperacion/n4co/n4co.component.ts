...
import { COperacionIntern3,COperacionIntern4 } from 'src/app/Interfaz/contabilidad';
import { ActivatedRoute, Router } from '@angular/router';


@Component({
  selector: 'app-n4co',
  templateUrl: './n4co.component.html',
  styleUrls: ['./n4co.component.css']
})
export class N4coComponent implements OnInit {
  formulario: FormGroup;
  activos: COperacionIntern3[] = [];
  filteredActivos: COperacionIntern3[] = []; // Lista filtrada de activos
  ...
  registrarcuenta() {
     ...
     const rcactivo: COperacionIntern4 = {
    ...
    this._rcontabilidadchicaService.postcostooperacion4(rcactivo).subscribe(_data => {
      this.mensajeExito('registrado');
      location.reload();
      this.router.navigate(['/coperacion4']);
    });
  }
  ...
  this._rcontabilidadchicaService.getcostooperacion3().subscribe(
    (activos: COperacionIntern3[]) => {
