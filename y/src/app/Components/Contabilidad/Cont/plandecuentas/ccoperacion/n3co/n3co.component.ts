...
import { COperacionIntern2,COperacionIntern3} from 'src/app/Interfaz/contabilidad';
...
@Component({
  selector: 'app-n3co',
  templateUrl: './n3co.component.html',
  styleUrls: ['./n3co.component.css']
})
export class N3coComponent implements OnInit {
  formulario: FormGroup;
  activos: COperacionIntern2[] = [];
  filteredActivos: COperacionIntern2[] = []; // Lista filtrada de activos
  ...
  registrarcuenta() {
     ...
     const rcactivo: COperacionIntern3 = {
    ...
    this._rcontabilidadchicaService.postcostooperacion3(rcactivo).subscribe(_data => {
      this.mensajeExito('registrado');
      location.reload();
      this.router.navigate(['/coperacion3']);
    });
  }
  ...
  this._rcontabilidadchicaService.getcostooperacion2().subscribe(
    (activos: COperacionIntern2[]) => {
