...
import { COperacionIntern4,COperacionIntern5 } from 'src/app/Interfaz/contabilidad';
import { ActivatedRoute, Router } from '@angular/router';


@Component({
  selector: 'app-n5co',
  templateUrl: './n5co.component.html',
  styleUrls: ['./n5co.component.css']
})
export class N5coComponent implements OnInit {
  formulario: FormGroup;
  activos: COperacionIntern4[] = [];
  filteredActivos: COperacionIntern4[] = []; // Lista filtrada de activos
  ...
  registrarcuenta() {
     ...
     const rcactivo: COperacionIntern5 = {
    ...
    this._rcontabilidadchicaService.postcostooperacion5(rcactivo).subscribe(_data => {
      this.mensajeExito('registrado');
      location.reload();
      this.router.navigate(['/coperacion5']);
    });
  }
  ...
  this._rcontabilidadchicaService.getcostooperacion4().subscribe(
    (activos: COperacionIntern4[]) => {
